...
import Logo from '../assets/img/1010-removebg-preview.png'

const Navbar = () => {
  return (
    <header className=" fixed w-full z-10 py-0.5 bg-tertiary shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
